...
import { deviceInfo } from '../../Onboarding/screens/Migration/util';
    ...
    <Box flexDirection="row" px={isVertical ? 1 : 0} mx={-3}>
      <Box flex={iconBoxFlex} mx={3} minW="56px" alignItems="center">
        <IconButton
          ...
          bgColor="home-buttons-bgc"
          borderColor="home-buttons-color"
          iconColor="home-buttons-color"
          isBorder={true} 
          onPress={() => {
